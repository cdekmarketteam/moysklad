...
use MoySklad\Entity\Document\RetailDrawerCashOut;
use MoySklad\Entity\ListEntity;
use MoySklad\Http\RequestExecutor;
use MoySklad\Util\Exception\ApiClientException;
use MoySklad\Util\Param\Param;

class RetailDrawerCashOutClient extends EntityClientBase
{
    use
    ...
    {
        parent::__construct($api, '/entity/retaildrawercashout/');
    }
